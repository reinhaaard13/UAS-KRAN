...
if (isset($_POST['addCust'])) {
    ...
    mysqli_query($conn, "INSERT INTO customer VALUES ('','$nama','$no_telp','$birth','1')");

    echo "
    <script>
        alert('Berhasil menambahkan customer baru!');
                        ...
                        <div class="card-body">
                            <form action="" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Customer" required autofocus autocomplete="off">
                                </div>
                                <div class="form-group">
                                ...
                                <button class="btn btn-lg btn-warning btn-block" type="submit" name="addCust">Add Customer</button>
                            </form>
                        </div>
                    </div>
                </div>
