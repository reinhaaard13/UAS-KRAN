                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <input type="text" id="inputAlamat" class="form-control" placeholder="Alamat" required autofocus><br>
                            ...
                            <button class="btn btn-lg btn-warning btn-block" type="submit">Add Barber!</button>
                        </form>
                                </table>
                            </div>
                        </div>
